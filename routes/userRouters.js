...
router.post('/send-invitation', validateToken, userController.sendInvitation); // Ensure this route comes before routes that expect an ObjectId parameter
router.post(
  '/manage-invitation',
  validateToken,
  userController.manageInvitation
); // Ensure this route comes before routes that expect an ObjectId parameter
